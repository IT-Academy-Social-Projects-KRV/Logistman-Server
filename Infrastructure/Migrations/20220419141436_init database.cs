        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true, defaultValue: new DateTimeOffset(new DateTime(2022, 4, 19, 14, 14, 35, 298, DateTimeKind.Unspecified).AddTicks(6857), new TimeSpan(0, 0, 0, 0, 0))),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalPassport = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadCapacity = table.Column<float>(type: "real", nullable: false),
                    MaxRouteDeviationKm = table.Column<int>(type: "int", nullable: false),
                    TripCreatorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    TransportationCarId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_Cars_TransportationCarId",
                        column: x => x.TransportationCarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ExpirationDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    GoodCategoryId = table.Column<int>(type: "int", nullable: false),
                    OfferPointId = table.Column<int>(type: "int", nullable: false),
                    RelatedTripId = table.Column<int>(type: "int", nullable: true),
                    OfferCreatorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatorRoleId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_Points_OfferPointId",
                        column: x => x.OfferPointId,
                        principalTable: "Points",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_Trips_RelatedTripId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatorUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ratings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_EstimatorUserId",
                        column: x => x.EstimatorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReportingDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    TripId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_EstimatorUserId",
                table: "Ratings",
                column: "EstimatorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_TransportationCarId",
                table: "Trips",
                column: "TransportationCarId");
